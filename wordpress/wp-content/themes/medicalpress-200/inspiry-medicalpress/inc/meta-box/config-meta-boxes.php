...
if( !function_exists( 'inspiry_register_meta_boxes' ) ) {
    function inspiry_register_meta_boxes() {
	    ...
	    if ( 'reborn' == INSPIRY_DESIGN_VARIATION ) {
		    ...
		    $meta_boxes[] = array(
			    'title' => __('Icon Settings', 'framework'),
			    'pages' => array('service'),
			    ...
			    'fields' => array(
				    array(
					    'name' => __('Service Icon', 'framework'),
					    'id' => "{$prefix}service_icon",
					    'desc' => __('The service icon should have minimum width and height of 64px (Bigger size icon will be adjusted proportionally).', 'framework'),
					    'type' => 'image_advanced',
					    'max_file_uploads' => 1
				    )
			    )
