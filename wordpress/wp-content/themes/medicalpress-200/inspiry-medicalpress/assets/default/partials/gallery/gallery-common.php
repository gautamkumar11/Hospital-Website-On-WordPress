            ...
            if ($gallery_query->have_posts()) {
                ...
                while ($gallery_query->have_posts()) {
                    ...
                    <div class="isotope-item <?php echo $gallery_terms_slugs; ?> <?php echo $bootstrap_classes; ?>">
                        <article class="common clearfix hentry <?php if (is_page_template('templates/gallery-four-col.php')) {
                            ...
                            <div class="content clearfix">
                                ...
                                <?php
                                if ( isset( $theme_options['display_gallery_categories'] ) ) :
                                    if ( '1' == $theme_options['display_gallery_categories'] ) : ?>
