...
<div class="doctors-posts doctors-page clearfix">
    ...
    <div class="container">
        <div id="isotope-container" class="isotope-wrapper row text-center">
            ...
            $doctor_query = new WP_Query(apply_filters('inspiry_sort_doctors', $args));
            ...
            if ($doctor_query->have_posts()) {
                ...
                } else if (is_page_template('templates/doctors-two-col.php')) {
                    ...
                    <div class="isotope-item <?php echo $doc_terms_slugs; ?> <?php echo $bootstrap_classes; ?>">
                        <article class="common-doctor clearfix hentry">
                            ...
                            <div class="text-content">
                                ...
                                <?php
                                if ( isset( $theme_options['display_doctor_department'] ) ) :
                                    if ( '1' == $theme_options['display_doctor_department'] ) : ?>
