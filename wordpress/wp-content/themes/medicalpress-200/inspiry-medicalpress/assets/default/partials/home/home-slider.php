...
$slider_button_text = isset( $theme_options['slider_button_text'] ) ? $theme_options['slider_button_text'] : __( 'Read More', 'framework' );
...
if ( ! empty( $slides ) ) : ?>
    <div class="home-slider clearfix">
        ...
        if (($theme_options['display_appointment_form'] == '1') && (($theme_options['appointment_form_variation'] == '1') || ($theme_options['appointment_form_variation'] == '2'))) {
            get_template_part(INSPIRY_PARTIALS . '/home/home-slider-form');
        }
        ?>
    </div>
<?php
