...
if ( ! function_exists( 'generate_dynamic_css' ) ) {
	...
	function generate_dynamic_css() {
		...
		if ( isset( $theme_options['header_nav_border_color'], $theme_options['responsive_menu_bar_bg_color'],
			$theme_options['overall_link_color'], $theme_options['default_btn_bg'],
			$theme_options['default_btn_text_color'], $theme_options['read_more_btn_bg'],
			$theme_options['read_more_btn_text_color'], $theme_options['appo_form_heading_bg_color'],
			$theme_options['appo_form_bg_color'], $theme_options['appo_calendar_hover_color'],
			$theme_options['footer_border_color'], $theme_options['footer_link_color'],
			$theme_options['footer_social_icons_color'] ) ) {
